...
const Footer = () => {
  ...
  return (
    <div className=" w-full mx-auto max-w-7xl text-[#B3B3B3] mb-25">
      <h6>Questions? Call <span className="underline cursor-pointer">000-800-919-1743</span></h6>
          ...
          <ul className="gap-2 flex  flex-col">
           {
              footerBtns[0].map((item)=>{
                return(
                  <li className="underline" >{item.name}</li>
                )
              })
...
<div>
      ...
      <div className="outline-1 px-4 py-1 rounded-md text-white outline-[#7e7e7e] w-fit my-8">
        ...
        <p className="my-6">This page is protected by Google reCAPTCHA to ensure you're not a bot.</p>
