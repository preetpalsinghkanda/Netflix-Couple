...
import { faPlay, faCircleInfo , faPlus } from "@fortawesome/free-solid-svg-icons";

const Home = () => {
  return (
    <div className="relative lg:h-[75vh] h-full w-full lg:overflow-hidden rounded-xl">
      ...
      <div className="flex flex-col  text-white absolute lg:justify-start lg:items-start lg:w-120 z-800 lg:top-30 justify-center items-center left-1/2 -translate-x-1/2 lg:left-0 lg:translate-x-0 top-100">
        ...
        <div className="flex lg:gap-4 my-6 gap-12">
          ...
          <button className="lg:hidden">
              <FontAwesomeIcon icon={faPlus} className="text-2xl text-[#ffffffe6]" />
              <h6 className="text-sm text-[#E5E5E0]">My List</h6>
          ...
          <button className="lg:hidden">
            <FontAwesomeIcon icon={faCircleInfo} className="text-2xl text-[#ffffffe6]" />
